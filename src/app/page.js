        ...
        <div className="flex flex-col items-center">
          ...
          <form className="flex flex-col gap-4 w-[100%] max-w-[100%]" action="" method="post" autoComplete='on'>
            <div className="flex flex-col gap-4 ">
              ...
              <input className="p-2 bg-green-pea-50 outline-emerald-800 rounded" type="text" name="email" />
            </div>
            <div className="flex flex-col gap-4"  >
              <label htmlFor="password"> Senha </label>
              <input className="p-2 bg-green-pea-50 outline-emerald-800 rounded" type="text" name="password" />
            </div>
            ...
            <div className="flex flex-col justify-center items-center ">
              ...
              <Button type="submit" variant="primary" icon={<PlusCircleIcon className="h-6 w-6" />} href="/analysisOfImages/new">Login </Button>

              <fieldset className="border-t border-green-pea-800 mt-[10px]">
                <legend className="mx-auto px-4 text-green-pea-800 text-1xl italic"> ou </legend>
                <div className="flex justify-center text-green-pea-800 pt-4"> Acesse com o seu: </div>
